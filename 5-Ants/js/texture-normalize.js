...
export const TextureNormalize = {
    async init(gl, canvasWidth, canvasHeight) {
        ...
        let textureNormalizeProgram = this.program = await createProgramFrom(gl,
            "./shaders/texture-draw/texture-draw-vertex-shader.vert",
            "./shaders/texture-normalize/texture-normalize-fragment-shader.frag");

        gl.useProgram(textureNormalizeProgram);
        ...
        let uniformLocations = getUniformLocations(gl, textureNormalizeProgram, ["u_texture"]);
        ...
        let attributeLocations = getAttributeLocations(gl, textureNormalizeProgram, ["a_position"]);
